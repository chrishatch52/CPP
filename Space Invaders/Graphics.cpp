...
#include "Graphics.h"
#include <iostream>
// source LazyFoo tutorials

Graphics::Graphics(SDL_Renderer* gRenderer)
{
	//Initialize
	mTexture = NULL;
	mWidth = 0;
...
bool Graphics::createBlank(int width, int height, SDL_TextureAccess access)
{
...
void Graphics::setAsRenderTarget()
{
...
void Graphics::copyPixels(void* pixels)
{
	//Texture is locked
	if (mPixels != NULL)
	{
...
Uint32 Graphics::getPixel32(unsigned int x, unsigned int y)
{
