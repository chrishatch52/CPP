...
namespace  MatrixOperations {
	...
	/*3x3 Matrix Ops*/
		static Mat3x3& operator*(const Mat3x3& lhs, const Mat3x3& rhs);
		static Mat3x3& operator+(const Mat3x3 & rhs);
	...
	/*4x4 Matrix Ops*/
		static Mat4x4& operator*(const Mat4x4& lhs, const Mat4x4& rhs);
		static Mat4x4& operator+(const Mat4x4& rhs);
